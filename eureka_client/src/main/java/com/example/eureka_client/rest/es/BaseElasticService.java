...
import com.example.eureka_client.dao.entity.ElasticEntity;
...
//            request.settings() 手工指定Setting
	...
	public void insertOrUpdateOne(String idxName, ElasticEntity entity) {
		...
		log.error("Data : id={},entity={}", entity.getId(), JSONUtil.toJsonStr(entity.getData()));
...
//        request.source(JSON.toJSONString(entity.getData()), XContentType.JSON);
	 ...
	 * @since
	 */
	private boolean isExistsIndex(String idxName) throws Exception {
